...
SPLIT_JSON="${SPLIT_JSON:-outputs/ood/split_seed_${SPLIT_SEED}/split.json}"
...
export SPLIT_SEED SPLIT_JSON OUT_ROOT GPU_ID DATA_GPU POSTPROC_GPU GEN_GPU EVAL_GPU CKPT_ROOT
