...
Это проверка качества на новых примерах **известных** паттернов. Перенос на новые задачи и сравнение с кронекеровым методом статьи 2020 года здесь не проводились. [Числа по каждому seed](data/2026-09-19/z_importance_summary.json).
