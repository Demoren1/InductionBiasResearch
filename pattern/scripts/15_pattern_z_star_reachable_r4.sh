#!/usr/bin/env bash
# Matched Gold-oracle vs task-z reachability experiment inside the R=4 ball.
set -euo pipefail
...
OUT_DIR="${OUT_DIR:-pattern/outputs/z_star_reachable/r4_multiseed8_20260912}"
...
python pattern/evaluation/z_star_reachable_r4.py \
