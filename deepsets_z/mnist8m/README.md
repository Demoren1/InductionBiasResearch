...
**Вывод:** в этих опытах обучаемый общий `z` не даёт воспроизводимого выигрыша относительно его отсутствия. Фиксированный `z` тоже не оказался надёжной заменой. Оценка всего на двух seeds после 500 эпох и отдельный провал переноса на длинные наборы не позволяют утверждать, что `z` бесполезен в любой архитектуре или задаче.
