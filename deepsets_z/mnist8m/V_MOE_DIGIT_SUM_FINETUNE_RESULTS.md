...
![Точность по длинам и валидационная ошибка при разных режимах заморозки](v_moe_digit_sum_middle_unfreeze.png)
...
![Влияние LR на точность и валидационную MAE MLP-роутера](v_moe_digit_sum_mlp_lr_sweep.png)
